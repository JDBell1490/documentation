...
.. note::
  ...
  - A subscription service counts, as it is considered a recurring product.
...
.. important::
   ...
   in exception`.  Reload the sales order, and the :guilabel:`Payment Failure` flag is gone.
